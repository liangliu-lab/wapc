    ...
    def group(self, params):
        ...
        try:
            ...
            if params.id and params.group:
                ...
                # gather device detail by provided id
                # set group to the device
                # update device

        except Exception as e:
            # TODO write a user friendly exception message to handle DeviceMethods.group method
            print e.message
            pass

    def deviceUpdate(self, params):
        """
